...
import eu.siacs.conversations.demo.AssignmentChatWeatherActivity;
...
public class SignupUtils {
    ...
    public static Intent getRedirectionIntent(final AssignmentChatWeatherActivity activity) {
        final XmppConnectionService service = activity.xmppConnectionService;
        Account pendingAccount = AccountUtils.getPendingAccount(service);
        Intent intent;
        if (pendingAccount != null) {
