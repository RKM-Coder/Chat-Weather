...
public abstract class XmppActivity extends ActionBarActivity {
    ...
    protected void onStart() {
        super.onStart();
        Log.e(Config.LOGTARAM,"onStart"+xmppConnectionServiceBound);
    ...
    public void connectToBackend() {
        Log.e(Config.LOGTARAM,"service start");
    ...
    protected void onStop() {
        super.onStop();
        Log.e(Config.LOGTARAM,"service stop");
        if (xmppConnectionServiceBound) {
    ...
    private void switchToConversation(Conversation conversation, String text, boolean asQuote, String nick, boolean pm, boolean doNotAppend) {
        Log.e(Config.LOGTARAM,"switchconversation");
